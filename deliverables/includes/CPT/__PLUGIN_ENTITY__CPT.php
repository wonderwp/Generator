...
class __PLUGIN_ENTITY__CPT extends CustomPostType
{
    public function __construct($name = '', array $passed_opts = [], $taxonomy_name = '', array $passed_taxonomy_opts = [])
    {
        ...
        $defaultOpts = [
            'labels'       => [
                'name'         => __($name . '.cpt', WWP___PLUGIN_CONST___TEXTDOMAIN),
                //'not_found'    => __($name . '.not_found', WWP___PLUGIN_CONST___TEXTDOMAIN),
                //'add_new_item' => __($name . '.add_new_item', WWP___PLUGIN_CONST___TEXTDOMAIN),
                //'edit_item'    => __($name . '.edit_item', WWP___PLUGIN_CONST___TEXTDOMAIN),
            ],
            'show_in_rest' => true,
